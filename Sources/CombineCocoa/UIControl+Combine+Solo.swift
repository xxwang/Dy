...
public extension UIControl {
    ...
    func solo_publisher(for events: UIControl.Event) -> ControlEvent<UIControl> {
    ...
    /// 点击（`.touchUpInside`）。
    var solo_tapPublisher: ControlEvent<Void> {
    ...
    var solo_valueChangedPublisher: ControlEvent<UIControl> {
        solo_publisher(for: .valueChanged)
    }
}
