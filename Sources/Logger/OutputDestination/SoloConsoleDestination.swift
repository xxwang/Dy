...
public final class SoloConsoleDestination {
    ...
    public init(
        subsystem: String = Bundle.main.bundleIdentifier ?? "com.solo.logger",
...
extension SoloConsoleDestination: SoloLogDestination {
...
// MARK: - 私有方法
private extension SoloConsoleDestination {
