...
@MainActor
public final class SoloHaptic {
    /// 触觉反馈类型
    public enum SoloFeedback {
        /// 触觉反馈
    ...
    public static let shared = SoloHaptic()
    private init() {}
...
// MARK: - 触觉反馈方法
public extension SoloHaptic {
    /// 触发触觉反馈
    /// - Parameter haptic: 触觉反馈类型
    func haptic(_ feedback: SoloFeedback) {
        switch feedback {
