...
public extension DyWrapper where Base: UICollectionView {
    ...
    func register(_ cell: (some UICollectionViewCell).Type) -> Self {
        base.register(cell, forCellWithReuseIdentifier: cell.dy_identifier)
        return self
    }
    ...
    func register(nib: UINib?, forCellWithClass cellType: (some UICollectionViewCell).Type) -> Self {
        base.register(nib, forCellWithReuseIdentifier: cellType.dy_identifier)
        return self
    }
    ...
    func register(supplementaryViewOfKind kind: String, withClass viewType: (some UICollectionReusableView).Type) -> Self {
        base.register(viewType, forSupplementaryViewOfKind: kind, withReuseIdentifier: viewType.dy_identifier)
        return self
    }
    ...
    func register(
        ...
        base.register(nib, forSupplementaryViewOfKind: kind, withReuseIdentifier: viewType.dy_identifier)
        return self
    }
