...
public extension CGMutablePath {
    ...
    /// - Returns: `Self`
    @discardableResult
    func dy_add(path: CGPath, withTransform transform: CGAffineTransform = .identity) -> Self {
    ...
    /// - Returns: `Self`
    @discardableResult
    func dy_add(rect: CGRect, withTransform transform: CGAffineTransform = .identity) -> Self {
    ...
    /// - Returns: `Self`
    @discardableResult
    func dy_add(rects: [CGRect], withTransform transform: CGAffineTransform = .identity) -> Self {
    ...
    /// - Returns: `Self`
    @discardableResult
    func dy_move(to point: CGPoint, withTransform transform: CGAffineTransform = .identity) -> Self {
    ...
    /// - Returns: `Self`
    @discardableResult
    func dy_addLine(to point: CGPoint, withTransform transform: CGAffineTransform = .identity) -> Self {
    ...
    /// - Returns: `Self`
    @discardableResult
    func dy_addLines(between points: [CGPoint], withTransform transform: CGAffineTransform = .identity) -> Self {
    ...
    /// - Returns: `Self`
    @discardableResult
    func dy_addEllipse(in rect: CGRect, withTransform transform: CGAffineTransform = .identity) -> Self {
