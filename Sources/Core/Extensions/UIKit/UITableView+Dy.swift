...
public extension UITableView {
    ...
    func dy_dequeueReusableCell<T: UITableViewCell>(withCellClass cellType: T.Type) -> T {
        guard let cell = self.dequeueReusableCell(withIdentifier: cellType.dy_identifier) as? T else {
    ...
    func dy_dequeueReusableCell<T: UITableViewCell>(
        ...
        guard let cell = self.dequeueReusableCell(withIdentifier: cellType.dy_identifier, for: indexPath) as? T else {
    ...
    func dy_dequeueReusableHeaderFooterView<T: UITableViewHeaderFooterView>(
        ...
        guard let view = self.dequeueReusableHeaderFooterView(withIdentifier: viewType.dy_identifier) as? T else {
