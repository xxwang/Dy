...
// MARK: - 属性
public extension SoloWrapper where Base: UIStoryboard {
...
public extension SoloWrapper where Base: UIStoryboard {
    ...
    func viewController<T: UIViewController>(withClass viewControllerClass: T.Type) -> T? {
    ...
    func viewController<T: UIViewController>(ofType type: T.Type, withIdentifier identifier: String) -> T? {
        return base.instantiateViewController(withIdentifier: identifier) as? T
    }
}
