...
public extension UIStoryboard {
    ...
    static func solo_main() -> UIStoryboard? {
...
public extension UIStoryboard {
    ...
    func solo_viewController<T: UIViewController>(withClass viewControllerClass: T.Type) -> T? {
    ...
    func solo_viewController<T: UIViewController>(ofType type: T.Type, withIdentifier identifier: String) -> T? {
        return self.instantiateViewController(withIdentifier: identifier) as? T
    }
}
