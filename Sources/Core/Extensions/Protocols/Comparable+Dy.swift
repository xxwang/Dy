...
// MARK: - 范围判断
public extension DyWrapper where Base: Comparable {
...
public extension DyWrapper where Base: Comparable, Base: Strideable, Base.Stride: SignedInteger {
...
public extension DyWrapper where Base: Comparable, Base: SignedNumeric {
    /// 计算与目标值的绝对距离
