...
public extension Comparable {
    ...
    /// - Returns: 是否包含
    func dy_isWithin(_ range: ClosedRange<Self>) -> Bool {
    ...
    /// - Returns: 是否包含
    func dy_isWithin(_ range: Range<Self>) -> Bool {
        return range.contains(self)
    }
    ...
    func dy_isWithin(array: [Self]) -> Bool {
...
public extension Comparable {
    ...
    /// - Parameter range: 闭区间
    /// - Returns: 裁剪后的值
    func dy_clamped(to range: ClosedRange<Self>) -> Self {
    ...
    /// - Returns: 裁剪后的值
    func dy_clamped(minimum: Self) -> Self {
    ...
    /// - Returns: 裁剪后的值
    func dy_clamped(maximum: Self) -> Self {
...
public extension Comparable where Self: Strideable, Self.Stride: SignedInteger {
    ...
    func dy_clamped(to range: Range<Self>) -> Self {
...
public extension Comparable where Self: SignedNumeric {
    ...
    func dy_distance(to target: Self) -> Self {
