...
public extension BidirectionalCollection {
    ...
    ///
    ///     let array = [1, 2, 3, 4, 5]
    ///     print(array.dy_prefix(count: 3)) // 输出:[1, 2, 3]
    ///
    func dy_prefix(count: Int) -> Self.SubSequence {
    ...
    ///
    ///     let array = [1, 2, 3, 4, 5]
    ///     print(array.dy_suffix(count: 3)) // 输出:[3, 4, 5]
    ///
    func dy_suffix(count: Int) -> Self.SubSequence {
