...
public extension BinaryInteger {
    ...
    func dy_decimal() -> Decimal {
        Decimal(string: self.dy_string()) ?? .zero
    }
...
public extension BinaryInteger {
    ...
    /// - Example:
    ///   ```swift
    ///     let radians = 180.dy_radians() // ≈ π
    ///     ```
    func dy_radians() -> Double {
    ...
    /// - Example:
    ///   ```swift
    ///     let degrees = Int.pi.dy_degrees() // ≈ 180.0
    ///     ```
    func dy_degrees() -> Double {
...
public extension BinaryInteger {
    ...
    /// - Example:
    ///   ```swift
    ///     let roman = 1987.dy_romanNumeral() // "MCMLXXXVII"
    ///     ```
    func dy_romanNumeral() -> String? {
