...
public extension BinaryInteger {
    ...
    func solo_decimal() -> Decimal {
        Decimal(string: self.solo_string()) ?? .zero
    }
...
public extension BinaryInteger {
    ...
    /// - Example:
    ///   ```swift
    ///     let radians = 180.solo_radians() // ≈ π
    ///     ```
    func solo_radians() -> Double {
    ...
    /// - Example:
    ///   ```swift
    ///     let degrees = Int.pi.solo_degrees() // ≈ 180.0
    ///     ```
    func solo_degrees() -> Double {
...
public extension BinaryInteger {
    ...
    /// - Example:
    ///   ```swift
    ///     let size = (1_572_864 as Int).solo_storageUnit() // "1.50 MB"
    ///     ```
    func solo_storageUnit() -> String {
    ...
    /// - Example:
    ///   ```swift
    ///     let roman = 1987.solo_romanNumeral() // "MCMLXXXVII"
    ///     ```
    func solo_romanNumeral() -> String? {
...
public extension BinaryInteger {
    ...
    /// - Example:
    ///   ```swift
    ///     let date = 1_609_459_200.solo_date() // 2021-01-01 UTC
    ///     let dateMs = 1_609_459_200_000.solo_date(isUnix: false) // 同上
    ///     ```
    func solo_date(isUnix: Bool = true) -> Date {
    ...
    /// - Example:
    ///   ```swift
    ///     let full = 3661.solo_durationString() // "01:01:01"
    ///     let minSec = 3661.solo_durationString(component: .minute) // "61:01"
    ///     ```
    func solo_durationString(component: Calendar.Component? = nil) -> String {
...
public extension BinaryInteger {
    ...
    /// - Example:
    ///   ```swift
    ///     let range = 10.solo_range(from: 5) // 5..<10
    ///     ```
    func solo_range(from: some BinaryInteger) -> CountableRange<Int> {
        Int(from) ..< Int(self)
    }
    ...
    /// - Example:
    ///   ```swift
    ///     let range = 5.solo_range(to: 10) // 5..<10
    ///     ```
    func solo_range(to: some BinaryInteger) -> CountableRange<Int> {
        Int(self) ..< Int(to)
    }
}
