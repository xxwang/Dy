...
public extension NSAttributedString {
    ...
    var dy_fullNSRange: NSRange {
        Foundation.NSRange(location: 0, length: length)
    }
}
...
public extension NSAttributedString {
    ...
    func dy_toMutable() -> NSMutableAttributedString {
...
public extension NSAttributedString {
    ...
    func dy_size(maxWidth: CGFloat = .greatestFiniteMagnitude, ceilResult: Bool = true) -> CGSize {
