...
public extension NSPredicate {
    ...
    ///   let notPred = pred.solo_not()
    ///   // 等价于 "NOT (age > 18)"
    ///   ```
    func solo_not() -> NSPredicate {
    ...
    func solo_and(_ other: NSPredicate) -> NSPredicate {
    ...
    func solo_or(_ other: NSPredicate) -> NSPredicate {
    ...
    func solo_excluding(_ other: NSPredicate) -> NSPredicate {
        return self.solo_and(other.solo_not())
    }
}
