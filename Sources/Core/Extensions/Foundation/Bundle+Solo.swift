...
public extension SoloWrapper where Base: Bundle {
    ...
    static var displayName: String {
        (Bundle.main.infoDictionary?["CFBundleDisplayName"] as? String) ?? self.name
    }
    ...
    static var userAgent: String {
        let appName = self.displayName.replacingOccurrences(of: " ", with: "_")
        let bundleID = self.identifier
...
public extension SoloWrapper where Base: Bundle {
    ...
    static func filePath(for fileName: String?, with fileExtension: String? = nil) -> String? {
    ...
    static func fileURL(for fileName: String?, with fileExtension: String? = nil) -> URL? {
