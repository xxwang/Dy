...
public extension Bundle {
    ...
    static var solo_appVersion: String {
        Bundle.main.object(forInfoDictionaryKey: "CFBundleShortVersionString") as? String ?? ""
    }

    /// 获取应用的构建版本号(CFBundleVersion)
    /// - Returns: 例如 "123";若未设置则返回空字符串
    static var solo_buildVersion: String {
    ...
    static var solo_namespace: String {
    ...
    static var solo_executableName: String {
    ...
    static var solo_displayName: String {
        (Bundle.main.infoDictionary?["CFBundleDisplayName"] as? String) ?? self.solo_name
    }
    ...
    static var solo_localizations: [String] {
    ...
    static var solo_userAgent: String {
        let appName = self.solo_displayName.replacingOccurrences(of: " ", with: "_")
        let bundleID = self.solo_identifier
        let appVersion = self.solo_appVersion
        let build = self.solo_buildVersion
...
public extension Bundle {
    ...
    static func solo_filePath(for fileName: String?, with fileExtension: String? = nil) -> String? {
    ...
    static func solo_fileURL(for fileName: String?, with fileExtension: String? = nil) -> URL? {
    ...
    static func solo_appIcon(in bundle: Bundle = .main) -> String? {
        guard
