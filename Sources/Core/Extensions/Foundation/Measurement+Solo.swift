...
extension Measurement: SoloExtension {}

// MARK: - 方法
public extension SoloWrapper where Base == Measurement<UnitAngle> {
    ...
    /// - Example:
    ///   ```swift
    ///   let angle = Measurement<UnitAngle>.solo.degrees(45.0)
    ...
    /// - Example:
    ///   ```swift
    ///   let angle = Measurement<UnitAngle>.solo.radians(Double.pi)
    ...
    /// - Example:
    ///   ```swift
    ///   let angle = Measurement<UnitAngle>.solo.arcMinutes(30.0)
    ...
    /// - Example:
    ///   ```swift
    ///   let angle = Measurement<UnitAngle>.solo.arcSeconds(1800.0)
    ...
    /// - Example:
    ///   ```swift
    ///   let angle = Measurement<UnitAngle>.solo.gradians(100.0)
    ...
    /// - Example:
    ///   ```swift
    ///   let angle = Measurement<UnitAngle>.solo.revolutions(2.5)
