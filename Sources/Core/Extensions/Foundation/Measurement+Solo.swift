...
public extension Measurement<UnitAngle> {
    ...
    /// - Example:
    ///   ```swift
    ///   let angle = Measurement<UnitAngle>.solo_degrees(45.0)
    ///   print(angle) // 45.0 degrees
    ///   ```
    static func solo_degrees(_ value: Double) -> Measurement<UnitAngle> {
    ...
    /// - Example:
    ///   ```swift
    ///   let angle = Measurement<UnitAngle>.solo_radians(Double.pi)
    ///   print(angle) // 3.141592653589793 radians
    ///   ```
    static func solo_radians(_ value: Double) -> Measurement<UnitAngle> {
    ...
    /// - Example:
    ///   ```swift
    ///   let angle = Measurement<UnitAngle>.solo_arcMinutes(30.0)
    ///   print(angle) // 30.0 arc minutes
    ///   ```
    static func solo_arcMinutes(_ value: Double) -> Measurement<UnitAngle> {
    ...
    /// - Example:
    ///   ```swift
    ///   let angle = Measurement<UnitAngle>.solo_arcSeconds(1800.0)
    ///   print(angle) // 1800.0 arc seconds (等于 0.5 度)
    ///   ```
    static func solo_arcSeconds(_ value: Double) -> Measurement<UnitAngle> {
    ...
    /// - Example:
    ///   ```swift
    ///   let angle = Measurement<UnitAngle>.solo_gradians(100.0)
    ///   print(angle) // 100.0 gradians (等于 90 度)
    ///   ```
    static func solo_gradians(_ value: Double) -> Measurement<UnitAngle> {
    ...
    /// - Example:
    ///   ```swift
    ///   let angle = Measurement<UnitAngle>.solo_revolutions(2.5)
    ///   print(angle) // 2.5 revolutions (等于 900 度)
    ///   ```
    static func solo_revolutions(_ value: Double) -> Measurement<UnitAngle> {
