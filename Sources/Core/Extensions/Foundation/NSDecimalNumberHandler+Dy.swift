...
public enum DyDecimalNumberHandlerOperator {
    ...
    ///   let result = DyDecimalNumberHandlerOperator.multiply.calculate(
...
public extension NSDecimalNumberHandler {
    ...
    static func dy_isDivisible(
        ...
        let result = self.dy_calculate(operator: .divide, valueA: valueA, valueB: valueB, roundingMode: .down, scale: 10)
    ...
    static func dy_intFloor(
        ...
        let result = self.dy_calculate(operator: .divide, valueA: valueA, valueB: valueB, roundingMode: .down, scale: 0)
    ...
    static func dy_calculatePercentage(
        ...
        let product = self.dy_calculate(operator: .multiply, valueA: value, valueB: percentage)
    ...
    static func dy_splitByRatios(
        ...
        let ratioSum = self.dy_sum(of: ratios)
