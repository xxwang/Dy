...
public extension NumberFormatter {
    ...
    static func dy_format(_ value: Decimal, style: NumberFormatter.Style = .decimal) -> String {
    ...
    /// - Returns: 格式化后的字符串
    static func dy_format(_ value: Double, style: NumberFormatter.Style = .decimal) -> String {
    ...
    ///   - style: 数字样式,默认为 `.decimal`
    /// - Returns: 格式化后的字符串
    static func dy_format(_ value: Float, style: NumberFormatter.Style = .decimal) -> String {
        return Self.localizedString(from: NSNumber(value: value), number: style)
    }
}
...
public extension NumberFormatter {
    ...
    ///   ```
    static func dy_reformat(_ string: String, style: NumberFormatter.Style = .decimal) -> String? {
...
public extension NumberFormatter {
    ...
    static func dy_withGroupingSeparator(_ string: String, separator: String = ",", groupingSize: Int = 3) -> String? {
        return self.dy_customFormat(string) { formatter in
            formatter.numberStyle = .decimal
    ...
    /// - Returns: 格式化后的字符串;失败返回 `nil`
    static func dy_padded(_ string: String, width: Int, padding: String = "0", position: NumberFormatter.PadPosition = .beforePrefix) -> String? {
        return self.dy_customFormat(string) { formatter in
