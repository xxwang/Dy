...
public extension Array {
    ...
    func solo_split(by chunkSize: Int) -> [[Element]] {
    ...
    func solo_grouped<T: Hashable>(by transform: (Element) throws -> T) rethrows -> [T: [Element]] {
    ...
    func solo_prepended(_ element: Element) -> [Element] {
        return [element] + self
    }
    ...
    mutating func solo_swap(at index1: Int, with index2: Int) {
        guard
            index1 != index2,
    ...
    func solo_safeValue(at index: Int, default defaultValue: @autoclosure () -> Element) -> Element {
...
public extension Array where Element: Equatable {
    ...
    func solo_indices(of element: Element) -> [Int] {
    ...
    func solo_index(where condition: (Element) throws -> Bool) rethrows -> Int? {
    ...
    func solo_index(of element: Element) -> Int? {
    ...
    @discardableResult
    mutating func solo_remove(_ element: Element, all: Bool = false) -> Self {
        if all {
...
public extension Array where Element: Hashable {
    ...
    /// - Returns: 修改后的数组（用于链式调用）
    @discardableResult
    mutating func solo_removeItems(_ elements: [Element], all: Bool = true) -> Self {
...
public extension Array where Element: NSAttributedString {
    ...
    func solo_combined() -> NSAttributedString {
