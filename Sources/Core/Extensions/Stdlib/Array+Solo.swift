...
// MARK: - Base.Index == Int
public extension SoloWrapper where Base: RandomAccessCollection, Base.Index == Int {
    /// 将数组按指定大小分割为多个子数组
...
public extension SoloWrapper where Base: Collection, Base.Element: Equatable, Base.Index == Int {
    /// 查找所有等于指定值的元素的索引
...
// MARK: - Element: Equatable
public extension SoloWrapper where Base: RangeReplaceableCollection, Base.Element: Equatable {
    /// 从数组中移除指定元素
    /// - Parameters:
    ///   - element: 要移除的元素
...
public extension SoloWrapper where Base: RangeReplaceableCollection, Base.Element: Hashable {
...
public extension SoloWrapper where Base: Sequence, Base.Element: NSAttributedString {
...
public extension SoloWrapper where Base: Sequence, Base.Element: NSObjectProtocol {
