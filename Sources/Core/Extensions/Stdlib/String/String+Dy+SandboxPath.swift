...
public extension DyWrapper where Base == String {
    ...
    func pathInCaches() -> String {
        DyPath.shared.path(inCaches: base)
    }
    ...
    func pathInTemporaryDirectory() -> String {
        DyPath.shared.path(inTemp: base)
    }
    ...
    func pathInApplicationSupport() -> String {
        DyPath.shared.path(inApplicationSupport: base)
    }
}
...
public extension DyWrapper where Base == String {
    ...
    func urlInDocuments() -> URL {
        DyPath.shared.url(inDocuments: base)
    }

    /// Caches 目录中对应文件的 URL
    func urlInCaches() -> URL {
        DyPath.shared.url(inCaches: base)
    }

    /// 临时目录(tmp)中对应文件的 URL
    func urlInTemporary() -> URL {
        DyPath.shared.url(inTemp: base)
    }

    /// Application Support 目录中对应文件的 URL
    func urlInApplicationSupport() -> URL {
        DyPath.shared.url(inApplicationSupport: base)
    }
}
