...
public protocol SoloOptionalProtocol {
    associatedtype Wrapped
    var wrapped: Wrapped? { get }
}

extension Optional: SoloOptionalProtocol {
    public var wrapped: Wrapped? {
        self
    }
}

extension Optional: SoloExtension {}
...
// MARK: - 可选值状态判断
extension SoloWrapper where Base: SoloOptionalProtocol {
    /// 判断可选值是否为 nil
    var isNil: Bool {
        switch base.wrapped {
        case .none:
...
// MARK: - 可选集合的空值判断
extension SoloWrapper where Base: SoloOptionalProtocol, Base.Wrapped: Collection {
    /// 判断可选集合是否为 nil 或内容为空
