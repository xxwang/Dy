import UIKit
import Combine
import SoloComponent

open class SoloViewController: UIViewController {
    ...
    /// 导航栏
    open lazy var naview = SoloNaView.naview()
        .solo.backAction { [weak self] in
...
// MARK: - SoloSetupable
@objc extension SoloViewController: SoloSetupable {
    /// 配置UI
    open func setupUI() {
        self
            .solo
...
// MARK: - 支持子类重写的方法
@objc extension SoloViewController {
    /// 更新导航栏位置及受影响的视图
...
@objc extension SoloViewController: UIGestureRecognizerDelegate {
