...
open class SoloTabBarController: UITabBarController {
...
// MARK: - SoloSetupable
@objc extension SoloTabBarController: SoloSetupable {
    /// 控制器初始化样式
    open func setupUI() {
        self
            .solo
...
// MARK: - 控制器设置
@objc extension SoloTabBarController {
    /// 是否接收屏幕旋转
...
@objc extension SoloTabBarController: UITabBarControllerDelegate {
    /// 即将选中
