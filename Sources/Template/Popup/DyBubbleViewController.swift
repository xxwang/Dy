...
@objc extension DyBubbleViewController {
    ...
    open func popoverBackgroundViewClass() -> (any UIPopoverBackgroundViewMethods.Type)? {
        return DyBubbleBackgroundView.self
    }
}
...
// MARK: - DyBubbleBackgroundView
open class DyBubbleBackgroundView: UIPopoverBackgroundView {
...
// MARK: - DyBubbleBackgroundView子类可重写配置
@objc extension DyBubbleBackgroundView {
    /// 气泡圆角半径
